...
class NutrientSensorController(
    ...
    private val log: Logger = LoggerFactory.getLogger(NutrientSensorController::class.java.name)
    ...
    fun createNutrientSensor(@SwaggerRequestBody(description = "Request to add a new nutrient sensor") @RequestBody request: CreateNutrientSensorRequest): ResponseEntity<String> {
        ...
        val sensor = nutrientSensorService.createSensor(request) ?: return ResponseEntity.badRequest()
            .body("Failed to create nutrient sensor")
    ...
    fun updateNutrientSensor(
        ...
        val sensor = nutrientSensorService.updateSensor(sensorId, request) ?: return ResponseEntity.badRequest()
            .body("Failed to update nutrient sensor")
        replConfig.regenerateSingleModel().invoke("nutrientSensors")
