...
class WaterBucketController(
    ...
    fun updateWaterBucket(
        @PathVariable bucketId: String,
        @SwaggerRequestBody(description = "Water bucket to be updated") @RequestBody updateRequest: UpdateWaterBucketRequest
    ): ResponseEntity<WaterBucket> {
